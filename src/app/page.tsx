...
import { BubbleBackground, Navbar, Header, SuggestionCard, ChatList, InputBox, ChatDashboard, ClearChatModal } from "@/components";
import { type Msg, type SavedChat } from "@/types";
...
export default function Home() {
  ...
  if (!isSignedIn) {
    return (
      <BubbleBackground interactive className="fixed inset-0">
